...
router.post('/tournaments/ai/suggestions', authenticateToken, async (req, res) => {
  try {
    ...
    return success(res, "Suggestions récupérées avec succès", suggestions)
  } catch (error) {
...
router.post('/tournaments/ai/personalized', authenticateToken, async (req, res) => {
  try {
    ...
    return success(res, "Recommandation générée avec succès", recommendation)
  } catch (error) {
...
router.post('/social/posts/:id/like', authenticateToken, async (req, res) => {
  try {
    ...
    return success(res, 'Post liké', { message: 'Post liké' })
  } catch (error) {
...
router.post('/social/posts/:id/comment', authenticateToken, async (req, res) => {
  try {
    ...
    return success(res, 'Commentaire ajouté', { message: 'Commentaire ajouté' })
  } catch (error) {
...
router.post('/social/posts/:id/share', authenticateToken, async (req, res) => {
  try {
    ...
    return success(res, 'Post partagé', { message: 'Post partagé' })
  } catch (error) {
...
router.post('/payments/create', authenticateToken, async (req, res) => {
  try {
    ...
    return success(res, 'Paiement créé avec succès', transaction)
  } catch (error) {
...
router.get('/payments/transactions', authenticateToken, async (req, res) => {
  try {
    ...
    return success(res, "Transactions récupérées avec succès", {
      transactions,
      pagination: {
        page: parseInt(page as string),
        limit: parseInt(limit as string),
...
router.get('/payments/stats', authenticateToken, async (req, res) => {
  try {
    ...
    return success(res, "Statistiques récupérées avec succès", {
      totalTransactions,
...
router.get('/players/:id/stats', async (req, res) => {
  try {
    ...
    return success(res, "Statistiques du joueur récupérées avec succès", stats)
  } catch (error) {
    console.error('Erreur lors de la récupération des statistiques:', error)
    return badRequest(res, 'Erreur lors de la récupération des statistiques')
  }
...
router.get('/players/:id/badges', async (req, res) => {
  try {
    ...
    return success(res, "Badges du joueur récupérés avec succès", badges)
  } catch (error) {
...
router.get('/matches/current', async (req, res) => {
  try {
    ...
    return success(res, "Match en cours récupéré avec succès", currentMatch)
  } catch (error) {
...
router.get('/matches/next', async (req, res) => {
  try {
    ...
    return success(res, "Matches à venir récupérés avec succès", upcomingMatches)
  } catch (error) {
