...
export declare const created: (res: Response, message: string, data: any) => Response<any, Record<string, any>>;
export declare const success: (res: Response, message: string, data?: any) => Response<any, Record<string, any>>;
