...
router.get('/tournaments/:id/tv-feed', async (req, res) => {
    try {
        ...
        return (0, apiResponse_1.badRequest)(res, 'Erreur lors de la génération du flux TV');
    }
});
router.get('/tournaments/:id/tv-data', async (req, res) => {
    try {
        ...
        return (0, apiResponse_1.badRequest)(res, 'Erreur lors de la récupération des données TV');
    }
});
function generateTVHTML(tournament, currentMatch, upcomingMatches) {
    return `
<!DOCTYPE html>
<html lang="fr">
<head>
