...
export declare const getPlayerById: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
...
export declare const getPlayersByTeam: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
